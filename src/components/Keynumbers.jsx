    ...
    return (
        <div className="bg-[#000000] text-white py-16 px-12">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-16 mt-16">
                ...
                <div
                    data-aos="fade-up"
                    className="bg-gray-700 rounded-lg shadow-lg text-left flex flex-col items-start w-64 h-90"
                >
                    <div
                        className="bg-gray-800 text-white rounded-lg p-8 w-full h-full flex flex-col items-start"
                        ref={ref1}
                    >
                        <img
                            src={imagePath.key1}
                            alt="Image description"
                            className="w-40 h-40 p-4 object-contain my-1 mx-auto"
                        />
                        {inView1 && (
                            <CountUp
                                start={0}
                ...
                >
                    ...
                    >
                        <img
                            src={imagePath.key3}
                            alt="Image description"
                            className="w-40 h-40 object-contain my-1 mx-auto"
                        />
                        {inView2 && (
                            <CountUp
                                start={0}

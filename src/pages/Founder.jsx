...
const Founder = () => {
    return (
        <>
            <div className="bg-gradient-to-t from-black to-gray-800 z-10 p-5 md:p-12 flex md:flex-row items-center justify-evenly w-full md:h-[350px] bg-black">
                <div>
                    <p className="text-white font-bold text-2xl md:text-6xl mb-2 md:mb-5">Mr. Sandeep Sawant</p>
                    <p className="text-[#FF0000] text-sm md:text-2xl">Founder & MD, Amppere Cable</p>
                </div>
                <div>
                    <img
                        src={imagePath.profile}
                        alt="Profile Image"
                        className="z-16 bg-white w-[110px] h-[110px] md:w-[310px] md:h-[310px] rounded-full"
                    />
                </div>
            </div>
